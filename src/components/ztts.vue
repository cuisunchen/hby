<template>
	<div class="content">
		...
		<div class="threeModel" ref="threeModel"></div>
	</div>
</template>

<script lang="ts" setup>
import { onMounted, ref, onUnmounted } from "vue";
import { Scene,PerspectiveCamera,DirectionalLight,AmbientLight,WebGLRenderer,Color,PointLight,Vector2,Raycaster,SkeletonHelper } from 'three'
...
const loadSoldier = () =>{
	...
	loader.load(`/static/threeModels/Soldier.glb`,(gltf) => {
		console.log(gltf)
		uni.hideLoading()
		...
		skeleton = new SkeletonHelper( gltf.scene );
